...
#### Cars distribution by gears and cylinders (Stacked bar)

```{r mtcars}
# data preparation: matrix to tibble
mtc <- as.tibble(mtcars)

# Plot: Stacked bar figure of the number of each gear type and how they are further divided out by cyl.
...
#### The relation between `Sepal.Length` and `Sepal.Width` in different `Species`
